...
module.exports = (app) => {
   ...
   */
  app.get(
    '/upgradeshop/api/v1/products/categories',
   ...
   * /products/:id
   */
  app.get('/upgradeshop/api/v1/products/:id', productController.getProductById);
  app.put(
    '/upgradeshop/api/v1/products/:id',
    [isAuthanticate, isAdmin],
  ...
  app.get('/upgradeshop/api/v1/products', productController.searchProduct);
};
